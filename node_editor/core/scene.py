...
class Scene(Serializable):
    ...
    def removeNode(self, node: Node) -> None:
        ...
        if node in self.nodes:
            ...
            print(f"!W: Scene::removeNode - trying to remove node {node} but it's not in the list!")
    ...
    def removeEdge(self, edge: Edge) -> None:
        ...
        if edge in self.edges:
            ...
            print(f"!W: Scene::removeEdge - trying to remove edge {edge} but it's not in the list!")
