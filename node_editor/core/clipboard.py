...
class SceneClipboard:
    ...
    def serializeSelected(self, delete: bool = False) -> OrderedDict:
        ...
        for edge in sel_edges:
            if (edge.start_socket.id in sel_sockets and
                ...
                if DEBUG:
                    print(f"edge {edge} is not connected with both sides")
    ...
    def deserializeFromClipboard(self, data: dict, *args, **kwargs) -> None:
        ...
        if DEBUG_PASTING:
            print(" *** PASTA:")
            print(f"Copied boundaries:\n\tX: {minx}, {maxx}   Y: {miny}, {maxy}")
            print(f"\tbbox_center: {relbboxcenterx}, {relbboxcentery}")
        ...
        for node_data in data['nodes']:
            ...
            if DEBUG_PASTING:
                ...
                print(f"\tnew node pos: {posx}, {posy}")
                print(f"\tFINAL: {newx}, {newy}")
